...
import { HandlerInterface, HandlerConstructorConfig, NetworkId } from "../../types/handler";

import { RPCService } from "../../src/services/rpc-service";
import { StorageService } from "./storage-service";
import { RpcType, getRpcUrls } from "../../types/shared";
import { NetworkName } from "../../types/handler";
...
export class RPCHandler implements HandlerInterface {
  ...
  constructor(config: HandlerConstructorConfig) {
    ...
    this._networkRpcs = networkRpcs[this._networkId].rpcs;
  ...
  public async testRpcPerformance(): Promise<JsonRpcProvider> {
    ...
    if (shouldRefreshRpcs) {
      this._runtimeRpcs = getRpcUrls(networkRpcs[this._networkId].rpcs);
